...
fo = sympify(fungsi)   
toleransi = float(input("masukan batas toleransi: "))
...
def Regulafalsi(a,b,fa,fb,fo,biterasi,toleransi):
    iterasi=0
    ...
    while True :
        iterasi += 1
        xt = float(a-fa*((b - a)/((fb - fa)))) # rumus mencari nilai tengah metode regulafalsi
        fc = fo.subs('x',xt)
...
hasil_akhir , iterasi_akhir = Regulafalsi(a,b,fa,fb,fo,biterasi,toleransi)
...
ass = int(input("masukan data yang diperlukan: "))
